...
description: "這是一篇關於影像辨識與類神經網路基礎的 PyTorch 教學指南。"
tags: [影像辨識, PyTorch, 機器學習]
category: "AI"
draft: false
---
...
#### 第六步
記憶和經驗：大腦將視覺信息與過去的經驗 and 知識結合起來，判斷出這是一隻貓。
...
梯度下降是一種優化算法，用於最小化（或最大化）函數的值。它在機器學習和深度學習中被廣泛應用，意是在訓練神經網絡時，用來調整模型的參數，以降低誤差或損失。
